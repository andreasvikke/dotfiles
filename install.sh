...
if [ "$hyprland" ]; then
  ...
  ln -sf ~/.cache/wal/pywal.kvconfig ~/.config/Kvantum/pywal/pywal.kvconfig
  ln -sf ~/.cache/wal/pywal.svg ~/.config/Kvantum/pywal/pywal.svg
  ls -sf ~/.cache/wal/pywal.json ~/.config/presets/user/pywal.json
